...
@TeleOp(name = "Teleop No chido")
public class TELEOPCHASIScopia extends OpMode {
    ...
    public void loop(){
        ...
        elevador1.setPower(gamepad2.left_stick_y*0.5);
        ...
        if(0.1 < gamepad2.left_trigger ) {
            brazo.setPower(-gamepad2.left_trigger * 0.4);

        } else if(0.1 < gamepad2.right_trigger ) {
            brazo.setPower(gamepad2.right_trigger * 0.4);
